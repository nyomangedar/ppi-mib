            ...
            <div>
                ...
                >
                    ...
                    <div className="px-5 mt-5">
                        ...
                        <p id="orgDescription">
                            PPI MIB merupakan rumah bagi para pelajar Indonesia
                            dan masyarakat Indonesia di Birmingham. Perhimpunan
                            ini 'mungkin' merupakan satu satunya perhimpunan
                            wilayah di United Kingdom yang anggotanya bukan
                            hanya pelajar, namun juga masyarakat Indonesia. Ini
                            menunjukkan semangat para pendiri PPI MIB terdahulu
                            untuk memperkuat silaturahmi dan kebersamaan yang
                            berasaskan Persatuan Indonesia di Birmingham.
                        </p>
                    </div>
                    <img
                ...
                >
                    ...
                    ></img>
                    <div
                        className={isLargeScreen ? "px-5 col-4" : "px-5 m-auto"}
                    >
                        <h3
                            style={{
                                color: "#1D1D59",
                        ...
                        <p id="orgDescription">
                            Menjadikan PPI MIB sebagai sarana kolaborasi antara
                            pelajar dan masyarakat Indonesia yang konstruktif,
                            sehat, kompak, menyenangkan dan berkesinambungan.
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <ul id="orgDescription">
                            ...
                            <li>
                                Memberikan dukungan akademik bagi para mahasiswa
                            </li>
                            <li>
                            ...
                            <li>
                                Menonjolkan dan mendukungan para mahasiswa dan
                                masyarakat Indonesia Birmingham yang berprestasi
                            </li>
                            <li>Mengimplementasikan Study-Life Balance</li>
                            <li>Memperhatikan pelajar muda Indonesia (anak)</li>
                            <li>
                                Mendukung serta memperkenalkan pariwisata
                                Indonesia
                            </li>
                        </ul>
                    </div>
                        ...
                        !isTabletOrMobile ? (
                            <>
                                <div className="m-auto px-5">
                                    ...
                                    <ul id="orgDescription">
                                        <li>
                                            Membangun rasa persaudaraan dan
                                            persatuan antara masayarakat dan
                                            pelajar
                                        </li>
                                        <li>
                                            Memberikan dukungan akademik bagi
                                            para mahasiswa
                                        </li>
                                        <li>
                                            Menjalin hubungan dengan organisasi
                                            nasional dan internasional
                                        </li>
                                        <li>
                                            Menonjolkan dan mendukungan para
                                            mahasiswa dan masyarakat Indonesia
                                            Birmingham yang berprestasi
                                        </li>
                                        <li>
                                            Mengimplementasikan Study-Life
                                            Balance
                                        </li>
                                        <li>
                                            Memperhatikan pelajar muda Indonesia
                                            (anak)
                                        </li>
                                        <li>
                                            Mendukung serta memperkenalkan
                ...
                <div className={useTabletorMobileStyle("px-5", "px-2", 400)}>
                    ...
                    <div className="mb-4">
                        <h2 className="fw-bolder">Festival Indonesia</h2>
                    ...
                    {/* ENTREPREUNERSHIP */}
                    <div className="mb-4">
                        <h2 className="fw-bolder">Entrepreneurship</h2>
                        <div className="cardHolder">
                            {entrepreunershipCards}
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        <h2 className="fw-bolder">
                            Professional Development and Institutional Affairs
                        </h2>
                    ...
                    <div className="mb-4">
                        <h2 className="fw-bolder">
                            Organisational Development and Alumni Engagement
                        </h2>
