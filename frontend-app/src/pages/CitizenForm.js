...
function CitizenForm() {
    ...
    const getUnfilledFields = (formData, currentPage) => {
        ...
        if (currentPage === 1) {
            ...
            if (isFieldEmpty(formData.province))
                unfilledFields.push("Province");
            if (isFieldEmpty(formData.city)) unfilledFields.push("City");
            if (isFieldEmpty(formData.district))
                unfilledFields.push("District");
            ...
            if (isFieldEmpty(formData.occupation))
                unfilledFields.push("Occupation");
